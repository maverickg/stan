...
\]
Thus the joint log likelihood is just the sum of the contributions for
the observations $y_n$.  For example, consider a 

 the
implementation of probability densities on the log scale, a primary
operation for which is summation of contributions from different



Continuing with the example of the normal probability density function
introduced in \refsection{probability-functions}, 
